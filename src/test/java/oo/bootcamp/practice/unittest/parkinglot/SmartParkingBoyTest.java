...
public class SmartParkingBoyTest {
    ...
    public void should_success_to_park_car_when_one_parkinglot_with_one_capacity() {
        ...
        ParkingBoy smartParkingBoy = ParkingBoy.smartParkingBoy(Collections.singletonList(parkingLot));
    ...
    public void should_success_to_pick_car_when_parked_a_car_in_one_parkinglot_with_one_capacity() {
        ParkingBoy smartParkingBoy = ParkingBoy.smartParkingBoy(Collections.singletonList(new ParkingLot(1)));
    ...
    public void should_success_to_park_car_when_two_parkinglot_both_empty() {
        ParkingBoy smartParkingBoy = ParkingBoy.smartParkingBoy(Arrays.asList(new ParkingLot(1), new ParkingLot(1)));
    ...
    public void should_success_to_park_at_second_when_two_parkinglot_first_has_one_space_second_has_two() {
        ...
        ParkingBoy smartParkingBoy = ParkingBoy.smartParkingBoy(Arrays.asList(oneSpaceParkinglot, twoSpaceParkingLot));
    ...
    public void should_success_to_park_car_in_first_parkinglot_when_two_parkinglot_both_one_space() {
        ...
        ParkingBoy smartParkingBoy = ParkingBoy.smartParkingBoy(Arrays.asList(oneSpaceParkinglot, anotherOneSpaceParkinglot));
    ...
    public void should_fail_to_park_car_when_two_parkinglot_both_full() {
        //given
        ParkingBoy smartParkingBoy = ParkingBoy.smartParkingBoy(Arrays.asList(new ParkingLot(0), new ParkingLot(0)));
